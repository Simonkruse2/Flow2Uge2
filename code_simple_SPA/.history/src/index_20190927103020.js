...
//----------------------------Clover---------------------------------------
north = document.querySelector("#north").addEventListener("click", clicked);
south = document.querySelector("#south").addEventListener("click", clicked);
west = document.querySelector("#west").addEventListener("click", clicked);
east = document.querySelector("#east").addEventListener("click", clicked);
