...
window.onload = function() {
  document.getElementById("north").addEventListener("click", clicked);
  document.getElementById("south").addEventListener("click", clicked);
  document.getElementById("west").addEventListener("click", clicked);
  document.getElementById("east").addEventListener("click", clicked);
