...
var namesWithPhoneTable =
  "<table>" +
  namesWithPhone
    .map(function(n) {
      return "<tr><td>" + n.name + "</td>" + "<td>" + n.phone + "</td></tr>";
    })
    .join("") +
  "</table>";
/*
document.getElementById("namesWithPhone").innerHTML = namesWithPhoneTable;
console.log(namesWithPhoneTable);
*/
/*
e) Add a button with a click-handler and use the filter method 
to find only names containing the letter ‘a’. Update the table to represent the filtered data.
*/

function namesWithPhoneTableWithA(array, callback) {
  "<table>" +
    array
      .map(function(n) {
        if (callback(array[i], i, array)) {
          return (
            "<tr><td>" + n.name + "</td>" + "<td>" + n.phone + "</td></tr>"
          );
        }
      })
      .join("") +
...
document.getElementById("namesWithPhoneTableWithA").innerHTML = namesWithPhoneTableWithA(names,namesFilteredFunction);
/*
document.getElementById("myBtn").addEventListener("click", function() {
  document.getElementById("namesWithA").innerHTML = "Hello World";
});
*/
console.log(namesWithPhoneTableWithA(names, namesFilteredFunction));
